			...
			function init() {
				...
				const container = document.querySelector( '#scene-benefits' );
				if ( !container ) return;
				
				containerWidth = container.clientWidth;
				containerHeight = container.clientHeight;

				camera = new THREE.PerspectiveCamera( 20, containerWidth / containerHeight, 1, 50000 );
				...
				effectFocus.uniforms[ 'screenWidth' ].value = containerWidth * window.devicePixelRatio;
				effectFocus.uniforms[ 'screenHeight' ].value = containerHeight * window.devicePixelRatio;
